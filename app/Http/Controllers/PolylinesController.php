...
class PolylinesController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Mencari nama file gambar lama berdasarkan ID polyline
        ...
        // Update the polyline data in the database
        if (!$this->polylines->find($id)->update($data)){
            return redirect()->back()->with('error', 'Gagal memperbarui data polyline');
            }

         // Kembali ke peta
         return redirect()->route('map')->with('success', 'Data polyline berhasil diperbarui');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('map')->with('error', 'Gagal menghapus polyline');
        }
       // Hapus file gambar jika ada
       if ($image != null) {
        //cek apakah file gambar ada sebelum dihapus
       ...
       // Kembali ke peta
       return redirect()->route('map')->with('success', 'Polyline berhasil dihapus');
